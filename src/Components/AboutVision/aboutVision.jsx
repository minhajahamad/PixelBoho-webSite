...
const AboutVision = () => (
  <section className="flex flex-col md:flex-row gap-10 justify-between items-start px-8 py-16 md:px-25 md:py-20 lg:px-30 xl:px-20 xl:py-20 gradient-div font-poppins">
