...
const HeroSection = () => {
  return (
    <div className="w-full  overflow-x-hidden  bg-black pl-[50px] md:pl-[120px] xl:pl-[200px]  py-10 lg:py-15 xl:py-20  z-10 relative  ">
      <img
      ...
      <p className=" w-[88%]  md:w-[69%] lg:w-[60%] xl:w-[50%]   desc-text  mt-8 md:mt-10 lg:mt-5  xl:mt-10">
