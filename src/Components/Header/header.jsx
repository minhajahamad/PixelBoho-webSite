...
const Header = ({ onServiceClick, onContactClick, onLogoClick }) => {
  ...
  return (
    <nav
      className={`w-screen h-[70px] xl:h-[100px]   bg-black flex  justify-between items-center md:justify-items-normal px-10 md:px-15 lg:px-25 xl:px-35 border-b border-[#d9d9d933]   fixed top-0 left-0  z-50 transition-transform duration-300 ${
