...
const Header = () => {
  return (
    <nav className=" h-[70px] sm:h-[85px] md:h-[95px] lg:h-[100px] xl:h-[100px]  bg-black flex items-center justify-between px-5 sm:px-6 md:px-15 lg:px-30 xl:px-35 2xl:px-50 border border-b-[#D9D9D933]">
