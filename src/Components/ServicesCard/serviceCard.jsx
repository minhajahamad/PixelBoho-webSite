...
const ServiceCard = () => {
  return (
    <div className="bg-black md:py-20 md:px-10 xl:py-1 ">
      <div className="font-semibold text-[70px] md:text-[110px] xl:text-[80px] leading-[75px] md:leading-[110px] xl:leading-[90px] flex flex-col xl:flex-row  gap-18 pl-[40px] xl:pl-[150px]   ">
        ...
        <div className="mt-3 xl:mt-1">
          ...
          <p className=" font-light text-[15px] md:text-[22px] xl:text-[17px] text-[#E2E2E2] xl:mt-9 w-full xl:w-[450px] leading-5 md:leading-8 xl:leading-6">
      ...
      <hr className="text-white w-[100%] md:w-[96%] xl:w-[90%] xl:mt-[5%]  mt-[50%] md:mt-[15%] mx-auto " />

      <div className="xl:mt-14 grid md:grid-cols-2  xl:grid-cols-4 gap-10 xl:px-[180px] px-10 py-10 xl:py-1 text-white font-normal font-marketing-1 text-[26px] leading-8 ">
        <div className="p-[.8px] xl:w-[230px] xl:h-[230px] rounded-[8px] animated-gradient-border relative cursor-pointer ">
        ...
        <div className="p-[.8px] xl:w-[230px] xl:h-[230px] rounded-[8px] animated-gradient-border   relative">
        ...
        <div className="p-[.8px] xl:w-[230px] xl:h-[230px] rounded-[8px] animated-gradient-border-1  relative">
