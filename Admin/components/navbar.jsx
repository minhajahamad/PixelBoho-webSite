...
import { LayoutDashboard, Briefcase, FileText, MessageSquare, Settings, LogOut, User, Menu, X } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
            ...
            {menuItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {item.label}
                  {item.id === "messages" && (
                    <Badge variant="secondary" className="ml-2 bg-red-100 text-red-800 text-xs px-1.5 py-0.5">
                      3
                    </Badge>
                  )}
                </Button>
          ...
          <div className="flex items-center space-x-4">
            {/* Logout Button */}
            <Button variant="ghost" className="text-red-600 hover:text-red-700 hover:bg-red-50/80 rounded-full px-4">
