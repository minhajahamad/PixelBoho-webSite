...
const Footer = () => {
  ...
  return (
    <div className="bg-black pt-5   px-4 xl:pt-10 md:px-10 lg:px-20 xl:px-28 flex flex-col relative z-10 overflow-x-hidden">
      <img
      ...
      {/* Bottom Section */}
      <div className="text-white flex flex-col md:flex-row justify-between items-center py-5 text-[12px] xl:text-[14px] relative z-10 gap-4">
        <div className="flex gap-10 md:gap-20 lg:gap-50 xl:gap-65">
          <p className="cursor-pointer hover:text-[#969696] transition-colors duration-300">
            ©2025 PixelBoho
          </p>
          <p
            onClick={() => navigate('/privacy-policy')}
            className="cursor-pointer hover:text-[#969696] transition-colors duration-300"
          >
            Privacy Policy
          </p>
          <p
        ...
        <div className="flex gap-5 items-center">
          <a
            href="https://www.facebook.com/people/PixelBoho-Creative-Digital-Agency/61566743772928/#"
            target="_blank"
          ...
          <a
            href="https://www.instagram.com/pixelboho_/?hl=en"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            href="https://www.linkedin.com/company/pixelboho/?originalSubdomain=in"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div className="bg-[#464646] w-[40px] h-[40px] rounded-full flex items-center justify-center hover:bg-[#ffff] transition-colors duration-300 cursor-pointer hover:text-[#0077B5]">
